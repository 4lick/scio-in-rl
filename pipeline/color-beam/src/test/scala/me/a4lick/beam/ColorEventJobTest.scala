...
import me.a4lick.beam.jobs.ColorEventFileToBq
...
final class ColorEventJobTest extends PipelineSpec {
  ...
  "From GCS to BQ" should "work..." in {
    JobTest[ColorEventFileToBq.type]
